...
(function($){
    ...
    table=$('#tests_table').DataTable( {
      ...
      "serverSide": true,
        ...
        "columns": [
          ...
          {data:"name2",sortable:true,orderable:true},
            ...
            <tr id="component_`+count+`" num="`+count+`">
               <td>
                    ...
                    <label for="name">{{ __('Working Mmethod') }}</label>
                        <textarea class="form-control" name="component[`+count+`][work_method]" placeholder="`+trans('Working Mmethod')+`"></textarea>
                    </div>
               </td>
               <td>
                    <div class="form-group">
                  ...
                  <table class="table table-bordered reference_range">
                    <thead>
                      <tr>
                        ...
                        <th class="statuses text-center">`+trans('Statuses')+`</th>
  ...
  $(document).on("click",".delete_option",function(){
    ...
    function(){
      ...
      {
        $.ajax({
          url:'/ajax/delete_option/'+option_id,
          beforeSend:function()
          {
            $('.preloader').show();
            $('.loader').show();
  ...
  $(document).on('click','.add_range',function(){
    ...
    <tr>
      ...
      <td class="text-center">
       ...
       <td class="text-center">
          <input type="text" name="component[`+component_num+`][reference_ranges][`+count_reference_ranges+`][low_risk]" class="form-control" required>
          :
          <input type="text" name="component[`+component_num+`][reference_ranges][`+count_reference_ranges+`][moderate_risk]" class="form-control" required>
          :
          <input type="text" name="component[`+component_num+`][reference_ranges][`+count_reference_ranges+`][high_risk]" class="form-control" required>
          :
          <input type="text" name="component[`+component_num+`][reference_ranges][`+count_reference_ranges+`][critical_extra_from]" class="form-control" required>
      </td>
