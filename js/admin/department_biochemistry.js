    ...
    (function($){
        ...
        //active
        $('#department_biochemistry').addClass('active');

        //Medical reports datatables
        table=$('#department_biochemistry_table').DataTable( {
    ...
    $(document).on('click','.delete_department_biochemistry',function(e){
        e.preventDefault();
        var el=$(this);
        swal({
