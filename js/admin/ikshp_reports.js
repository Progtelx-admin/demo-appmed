    ...
    (function($){
        ...
        //active
        $('#ikshp_reports').addClass('active');

        //Medical reports datatables
        table=$('#medical_reports_table').DataTable( {
            "lengthMenu": [[30, 40, 70,100,500,1000, -1], [30, 40, 70,100,500,1000 ,"All"]],
            ...
            "ajax": {
                ...
                data:function(data)
                {
                    ...
                    data.filter_tests=$('#filter_tests').val();
                }
            },
            fixedHeader: true,
            "columns": [
                ...
                {data:"results",searchable:false,orderable:false,sortable:false},
        ...
        $('#filter_tests').on('input',function(){
            table.draw();
        });
