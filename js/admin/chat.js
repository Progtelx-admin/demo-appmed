...
(function($){
  ...
  function get_unread_messages_count()
  {
      $('.user_unread_count').each(function(){
         ...
         var el=$(this);
         $.ajax({
           url:"/ajax/get_unread_messages_count/"+user_id,
  ...
  function load_more()
  {
      ...
      $.ajax({
          url:"/ajax/load_more/"+user_id+"/"+message_id,
          type:"get",
          beforeSend:function(){
              $('.preloader').show();
              $('.loader').show();
...
function check_messages()
{
    ...
    {
      $.ajax({
          url:'/ajax/get_my_messages/'+user_id,
          success:function(messages)
          {
