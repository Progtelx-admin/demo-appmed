...
class DepartmentBiochemistryController extends Controller
{
    /**
     * assign roles
     */
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            $model = Group::query()
                ->with('patient', 'tests', 'contract', 'signed_by_user', 'created_by_user')
            ...
            return DataTables::eloquent($model)
                ...
                ->editColumn('tests', function ($group) {
                    return view('admin.department_biochemistry._tests', compact('group'));
                })
                ->addColumn('signed', function ($group) {
                    return view('admin.department_biochemistry._signed', compact('group'));
                })
                ->addColumn('signed2', function ($group) {
                    return view('admin.department_biochemistry._signed2', compact('group'));
                })
                ->editColumn('done', function ($group) {
                    return view('admin.department_biochemistry._status', compact('group'));
                })
                ->editColumn('sent', function ($group) {
                    return view('admin.department_biochemistry._status2', compact('group'));
                })
                ->addColumn('action', function ($group) {
                    return view('admin.department_biochemistry._action', compact('group'));
                })
        ...
        return view('admin.department_biochemistry.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.department_biochemistry.show', compact('group', 'next', 'previous'));
    }
    ...
    public function show2($id)
    {
        ...
        return view('admin.department_biochemistry.show2', compact('group', 'next', 'previous'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.department_biochemistry.index');
    }
    ...
    public function edit($id)
    {
        ...
        $laboratories = Laboratory::select(['SampleNo', 'LIMSTestParam', 'ResultValue', 'ResultTransferDtTm'])->join('tests', 'tests.id', '=', 'LIMSTestParam')->where('SampleNo', '=', $group['barcode'])->withTrashed()->get();
        ...
        return view('admin.department_biochemistry.edit', compact('group', 'select_antibiotics', 'next', 'previous', 'laboratories'));
    }
