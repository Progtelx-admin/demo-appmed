...
class MicrobiologyController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $model = Group::query()
                ->with('patient', 'cultures', 'all_cultures', 'contract', 'signed_by_user', 'created_by_user')
            ...
            return DataTables::eloquent($model)
                ...
                ->editColumn('cultures', function ($group) {
                    return view('admin.microbiologys._cultures', compact('group'));
                })
        ...
        return view('admin.microbiologys.index');
    }
