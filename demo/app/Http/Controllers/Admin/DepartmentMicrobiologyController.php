...
class DepartmentMicrobiologyController extends Controller
{
    /**
     * assign roles
     */
    ...
    public function edit($id)
    {
        ...
        return view('admin.medical_reports.edit', compact('group', 'select_antibiotics', 'next', 'previous', 'laboratories'));
    }
