            ...
            @if ($reports_settings['show_header'] && isset($group['branch']))
                @if ($group['branch']['show_header_image'])
                    <table width="100%" style="padding:0px">
                        <tbody>
                            <tr>
                                <td align="center" style="padding:0px; border: none">
                ...
                @else
                    <table width="100%" class="pdf-header header" style="border: none">
                        <tbody>
                            <tr>
    ...
    @if ($reports_settings['show_signature'] || $reports_settings['show_qrcode'])
        <div style="display: flex; justify-content: space-between;">
            @if (!empty($group['signed_by4']))
                <p>
                    <img src="{{ url('uploads/signature4/' . $group['signed_by_user4']['signature4']) }}" alt="" height="150">
                </p>
            @endif
            @if (!empty($group['signed_by3']))
                <p>
                    <img src="{{ url('uploads/signature3/' . $group['signed_by_user3']['signature3']) }}" alt="" height="150">
                </p>
            @endif
        </div>
    @endif
