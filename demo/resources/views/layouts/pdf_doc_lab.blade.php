...
<head>
    ...
    <style>
        ...
        .labValidation .title h4,
        .labValidation .name h4 {
...
<body>
    ...
    <htmlpagefooter name="page-footer" class="page-footer">
        @if ($type == 1)
            @if ($reports_settings['show_signature'] || ['show_footer'])
                <table>
                    <tbody>
                        <tr>
                            <td width="25%" align="center">
                                @if ($reports_settings['show_signature'])
                                    @if (!empty($group['signed_by2']))
                                        <p>
                                            <img src="{{ url('uploads/signature2/' . $group['signed_by_user2']['signature2']) }}"
                                                alt="" max-height="300">
                                        </p>
                                    @endif
                                @endif
                            ...
                            <td width="50%">
                                @if ($type == 1 || $type == 2)
                                    @if ($group['branch']['show_footer_image'])
                                        <img src="{{ url('uploads/branches/' . $group['branch']['footer_image']) }}"
                                            alt="">
                                    @else
                                        <table width="100%">
                                            <tbody>
                                    ...
                                    @endif
                                @endif
                            </td> <!-- Add an empty column to create space between the signatures -->
                            <td width="25%" align="center">
                                @if ($reports_settings['show_signature'])
    ...
    <!--<htmlpagefooter name="page-footer" class="page-footer">-->
    <!--    <table class="validationFooter">-->
    <!--        <tr>-->
    <!--            @if ($group['signed_by2'])-->
    <!--                <td class="labValidationContainer" style="padding: 0; width: 20px">-->
    <!--                <td class="labValidation">-->
    <!--                    <table style="max-width: 50%">-->
    <!--                        <tr>-->
    <!--                            <td class="titleOfLab">-->
    <!--                                <label for="validation">{{ __('Technical Validation') }}: </label>-->
    <!--                                <hr style="color: 1px solid rgba(0, 128, 0, 0.5); width: 70%; margin: 5px 0;">-->
    <!--                                <p>-->
    <!--                                    <img src="{{ url('uploads/signature2/' . $group['signed_by_user2']['signature2']) }}"-->
    <!--                                        alt=""-->
    ...
    <!--            @if ($group['signed_by'])-->
    <!--                <td class="docValidationContainer" style="padding: 0;  width: 20px">-->
    <!--                <td class="docValidation">-->
    <!--                    <table style="max-width: 50%">-->
    <!--                        <tr>-->
    <!--                            <td class="titleOfDoc">-->
    <!--                                <label for="validation">{{ __('Medical Validation') }}: </label>-->
    <!--                                <hr style="color: 1px solid rgba(0, 128, 0, 0.5); width: 70%; margin: 5px 0;">-->
    <!--                                <p>-->
    <!--                                    <img src="{{ url('uploads/signature/' . $group['signed_by_user']['signature']) }}"-->
    <!--                                        alt=""-->
    <!--                                        style="max-width:150px !important; min-width: 150px; max-height: 100px; min-height: 100px">-->
    <!--                                </p>-->
    <!--                            </td>-->
    <!--                        </tr>-->
    <!--                    </table>-->
    ...
    <!--                        <td width="25%" align="center">-->
    <!--                            @if ($reports_settings['show_signature'])-->
    <!--                                @if (!empty($group['signed_by12']))-->
    <!--                                    <p>-->
    <!--                                        <img src="{{ url('uploads/signature3/' . $group['signed_by_user3']['signature']) }}"-->
    <!--                                            alt="" max-height="300">-->
    <!--                                    </p>-->
    <!--                                @endif-->
    <!--                            @endif-->
