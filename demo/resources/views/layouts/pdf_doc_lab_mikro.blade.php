                        ...
                        <tr>
                            <td width="25%" align="center">
                                @if ($reports_settings['show_signature'])
                                    @if (!empty($group['signed_by4']))
                                        <p>
                                            <img src="{{ url('uploads/signature4/' . $group['signed_by_user4']['signature4']) }}"
                                                alt="" max-height="300">
                                        </p>
                                    @endif
                                @endif
                            ...
                            <td width="25%" align="center">
                                @if ($reports_settings['show_signature'])
                                    @if (!empty($group['signed_by3']))
                                        <p>
                                            <img src="{{ url('uploads/signature3/' . $group['signed_by_user3']['signature3']) }}"
                                                alt="" max-height="300">
                                        </p>
                                    @endif
                                @endif
