<div class="row">
    ...
    <div class="col-lg-4">
      ...
      <div class="form-group" style="color: #f9bf3b">
        ...
        <input style="border-color: #f9bf3b !important" type="text" class="form-control" name="pantheon_id" id="pantheon_id" @if(isset($culture)) value="{{$culture['pantheon_id']}}" @endif required>
      </div> 
    </div>
    <div class="col-lg-12">
        <div class="form-group">
