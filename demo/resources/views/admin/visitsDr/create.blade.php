            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{route('admin.visitsDr.index')}}">{{ __('Home visits') }}</a>
                    </li>
...
<div class="card card-primary">
    ...
    <!-- /.card-header -->
    <form method="POST" action="{{route('admin.visitsDr.store')}}" enctype="multipart/form-data" id="visit_form">
        @csrf
        <div class="card-body">
            <div class="col-lg-12">
                @include('admin.visitsDr._form')
            </div>
        </div>
...
@section('scripts')
    ...
    <script src="{{url('js/admin/visitsDr.js')}}"></script>
@endsection