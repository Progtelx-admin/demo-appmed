<div class="row">
    ...
    <div class="col-lg-3">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="name2" id="name2" @if(isset($test)) value="{{$test->name2}}" @endif>
      </div> 
    </div>
    <div class="col-lg-3">
      <div class="form-group">
        <label for="name">{{__('Working Mmethod')}}</label>
        <input type="text" class="form-control" name="work_method" id="work_method" @if(isset($test)) value="{{$test->work_method}}" @endif>
      </div> 
    </div>
    <div class="col-lg-3">
      <div class="form-group">
    ...
    <div class="col-lg-3">
      ...
      <div class="form-group" style="color: #f9bf3b">
        ...
        <input style="border-color: #f9bf3b !important" type="text" class="form-control" name="pantheon_id" id="pantheon_id" @if(isset($test)) value="{{$test['pantheon_id']}}" @endif required>
      </div> 
    </div>
    <div class="col-lg-12">
        <div class="form-group">
                                                ...
                                                <td colspan="6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="component[{{$count}}][name2]" placeholder="{{__('Name 2 srb')}}" value="{{$component['name2']}}">
                                                           ...
                                                           <div class="form-group">
                                                        <label for="name">{{ __('Working Mmethod') }}</label>
                                                        <textarea lass="form-control" name="component[{{ $count }}][work_method]" cols="10" rows="10">
                                                                {{ $component['work_method'] }}</textarea>
                                                    </div>
                                                </td>
                                                <td>
                                                    ...
                                                    <table class="table table-bordered reference_range">
                                                        <thead>
                                                            <tr>
                                                              ...
                                                              <th class="statuses text-center">{{__('Statuses')}}</th>
                                                        ...
                                                        <tbody>
                                                            @foreach($component['reference_ranges'] as $reference_range)
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <input type="text" name="component[{{$count}}][reference_ranges][{{$count_reference_ranges}}][low_risk]" class="form-control" value="{{$reference_range['low_risk']}}">:
                                                                        <input type="text" name="component[{{$count}}][reference_ranges][{{$count_reference_ranges}}][moderate_risk]" class="form-control" value="{{$reference_range['moderate_risk']}}">:
                                                                        <input type="text" name="component[{{$count}}][reference_ranges][{{$count_reference_ranges}}][high_risk]" class="form-control" value="{{$reference_range['high_risk']}}">:
                                                                        <input type="text" name="component[{{$count}}][reference_ranges][{{$count_reference_ranges}}][critical_extra_from]" class="form-control" value="{{$reference_range['critical_extra_from']}}">
                                                                    </td>
                                                                    <td class="text-center">
