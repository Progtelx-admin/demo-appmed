@extends('layouts.healthcertificate')
@section('content')
        ...
        <htmlpageheader><br><br><br>
            ...
            <div class="home-container">
                <header data-role="Header" class="home-header">
                    ...
                    <!--      <span style="font-size: 22px; color:red;"> {{ $healthcertificate['reg_no'] }}-->
                    <!--  </span> </nav>-->
            ...
            <h5 class="text-center" style="font-size:12px; margin-left: 25px;margin-top:-30px; margin-bottom:-12px; ">Për
                punësim <br> <i> Za zaposljenje</i><br>&emsp; </h5>
            ...
            @if (isset($healthcertificate['patient']))
                    ...
                    <tbody>
                        <tr>
                            <td width="50%" style="border: 2px solid blackc; padding:4px;">
                                ...
                                <span class="data" style="font-size:10px;">
                                    &nbsp; DEMO
                                    <!-- Poliklinika "Pinea Medical Center" -->
                                </span>
                            </td>
                        ...
                        <tr>
                            <td width="50%" style="border: 2px solid black;padding:4px;">
                                ...
                                <span class="data" style="font-size:10px;">
                                    &nbsp; {{ $healthcertificate['branch']['fiskal_no'] }}
                                </span>
                            </td>
                            <td width="50%" style="border: 2px solid black;padding:4px">
                                ...
                                <span class="data" style="font-size:10px;">
                                    &nbsp; {{ $healthcertificate['patient']['national_id'] }}
                                </span>
                            </td>
                        ...
                        <tr>
                            <td width="50%" style="border: 2px solid black; padding:4px">
                                @if ($healthcertificate['visit_type'] == 'Publik')
                                    <span class="title" style="font-size:9px;">{{ __('Publik / ') }} </span>
                                    <span class="title" style="font-size:9px;"><i>{{ __(' Javna') }} </i></span>

                                    <span class="data" style="font-size:10px;">
                                        &nbsp; {{ $healthcertificate['visit_type'] }}
                                    </span>
                                @else($healthcertificate['visit_type'] == 'Privat')
                        ...
                        <tr>
                            ...
                            <td width="50%" style="border: 2px solid black; padding:4px;">
                                ...
                                <span class="data" style="font-size:10px;">
                                    &nbsp; {{ $healthcertificate['patient']['passport_no'] }}
                                </span>
                            </td>
                        ...
                        <tr>
                            <td width="50%" style="border: 2px solid black; padding:4px;">
                                <span class="title" style="font-size:9px;">{{ __('Nr.kartelës Shëndetësore / ') }}
                                </span>
                                <span class="title" style="font-size:9px;"><i>{{ __(' Br. Zdravstvenog Kartona') }}
                                    </i></span>
                                <span class="data" style="font-size:10px;">
                                    <!--new-->
                                </span>
                        ...
                        <tr>
                            <td width="50%" style="border: 2px solid black; padding:4px;">
                                ...
                                <span class="data" style="font-size:10px;">
                                    &nbsp;{{ $healthcertificate['protocol_no2'] }}
                                </span>
                            </td>
                            <td width="50%" style="border: 2px solid black; padding:4px;">
                                ...
                                <span class="data">
                                    ...
                                    <span class="data" style="font-size:10px;">
                                        &nbsp;{{ $healthcertificate['patient']['gender'] }}
                                    </span>
                                </span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="50%" style="border: 2px solid black; padding:4px;">
                                ...
                                <span class="data" style="font-size:10px;">
                                    &nbsp;{{ $healthcertificate['patient']['address'] }}
                                </span>
                            </td>
                        </tr>
                        <tr>
                            <td width="50%" style="border: 2px solid black; padding:4px;">
                                ...
                                <span class="data" style="font-size:10px;">
                                    &nbsp;{{ $healthcertificate['doctor']['doctor_code'] }}
                                </span>
                            </td>
                            <td width="50%" style="border: 2px solid black; padding:4px;">
                                ...
                                @if ($healthcertificate['alergy'] == 'Mohon')
                                    <span class="data" style="font-size:10px;">
                                        &nbsp;{{ $healthcertificate['alergy'] }}
                                    </span>
                                @else($healthcertificate['alergy'] == 'Pohon')
                                    <span class="data" style="font-size:10px;">
                                        &nbsp;{{ $healthcertificate['alergy'] }}
                                    </span>
                                @endif
                        ...
                        <tr>
                            <td width="50%" style="border: 2px solid black; padding:4px;">
                                ...
                                <span class="data" style="font-size:10px;">
                                    &nbsp;{{ $healthcertificate['branch']['email'] }}
                                </span>
                            </td>
                            <td width="50%" style="border: 2px solid black; padding:4px;">
                                <!--<span class="title" style="font-size:9px;">{{ __('E-mail') }} </span>-->
                    ...
                    <div class="home-feature-card">
                        <h2 class="home-text04" style="margin-left:-1px">
                            ...
                            <span style="font-size:11px;">
                                Mjeku i Përgjithshëm, Specialisti i Mjekësisë Familjare &nbsp;
                            </span>
                            <br />
                            <span style="font-size:11px;">
                                <i>Lekar opste prakse, Specijalista Porodicne Medicine</i>
                            </span>
                        </h2>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <span class="fix"> &nbsp; &nbsp;&nbsp; &nbsp; {{ $healthcertificate['visit_date'] }}&nbsp; &nbsp;
                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
                        <i> Mesto:</i>&nbsp; {{ $healthcertificate['branch']['address'] }} </span><br>
                    <nav class="navigation-links-nav navigation-links-root-class-name11">
                        ...
                        <span
                            class="navigation-links-text1"><span><i>Direktor:</i>&nbsp;_________________________</span></span></span>
                    </nav>
