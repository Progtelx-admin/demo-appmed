            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{route('admin.users.index')}}">{{ __('Health Certificates') }}</a>
                    </li>
                    <li class="breadcrumb-item active">{{ __('Edit Health Certificate') }}</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">{{ __('Edit Health Certificate') }}</h3>
    </div>
    <!-- /.card-header -->
    <form method="POST" action="{{route('admin.healthcertificates.update',$healthcertificate['id'])}}" enctype="multipart/form-data"  id="healthcertificate_form">
        @csrf
        @method('put')
        <div class="card-body">
            <div class="col-lg-12">
