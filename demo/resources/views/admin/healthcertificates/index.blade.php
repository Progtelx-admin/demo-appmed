      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="#">{{__('Health Certificates')}}</a></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="card card-primary card-outline">
    <div class="card-header">
      <h3 class="card-title">
        {{__('Health Certificates table')}}
      </h3>
      @can('create_visit')
        <a href="{{route('admin.healthcertificates.create')}}" class="btn btn-primary btn-sm float-right">
    ...
    <div class="card-body">
        ...
        <div class="col-lg-12 table-responsive">
            <table id="healthcertificates_table" class="table table-striped table-bordered"  width="100%">
              <thead>
                <tr>
                  <th width="10px">
                  ...
                  <th width="10px">#</th>
                  <th>{{__('Health Certificate Type')}}</th>
                  <th>{{__('Contract')}}</th>
                  <th>{{__('Doctor')}}</th>
