              ...
              <table class="table table-striped table-bordered">
                <thead>
                  <tr>
                    ...
                    <th width="200px" class="text-center">{{__('Result Lab')}}</th>
                      ...
                      @else
                        <tr>
                          ...
                          <td>
                            ...
                            @endif
                            <td style="width:10px" class="text-center">{{$result['result']}}</td>
                          </td>
                          <td style="width:10px" class="text-center">
                            @if($result['component']['status'])
                              <select name="result[{{$result['id']}}][status]" class="form-control select_result status">
                                ...
                                <!-- New status -->
                                @if(!empty($result['status'])&&!in_array($result['status'],['High','','Low']))
