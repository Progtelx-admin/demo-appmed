            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{route('admin.users.index')}}">{{ __('Home appointments') }}</a>
                    </li>
...
<div class="card card-primary">
    ...
    <!-- /.card-header -->
    <form method="POST" action="{{route('admin.appointments.update',$appointment['id'])}}" enctype="multipart/form-data"  id="appointment_form">
        @csrf
        @method('put')
        <div class="card-body">
            <div class="col-lg-12">
