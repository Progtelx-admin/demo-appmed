...
<form method="POST" action="{{route('admin.medical_reports.pdf',$group['id'])}}" id="print_form">
    ...
    <div class="row mb-3">
        <div class="col-lg-12">
            ...
            <div class="col-lg-12">
            <a href="{{$group['report_pdf2']}}" class="btn btn-danger float-right" target="_blank">
                <i class="fa fa-file-pdf"></i>
                {{__('Print uploaded report 2')}}
            </a>
        </div>
        </div>
    </div>
    ...
    <div class="row mb-3">
        <div class="col-lg-7">
            ...
            <button type="submit" class="btn btn-primary float-right d-inline mr-2">
                <i class="fa fa-print"></i>
                {{__('Print')}}
            </button>
            
            <button  type="submit" class="btn btn-primary float-right d-inline mr-2" formaction="{{route('admin.medical_reports.pdf2',$group['id'])}}" formmethod="POST">
                <i class="fa fa-print"></i>
                {{__('Print 2')}}
            </button>
            ...
            <button type="submit" class="btn btn-primary float-right d-inline mr-2" formaction="{{route('admin.medical_reports.pdf3',$group['id'])}}" formmethod="POST">
                <i class="fa fa-print"></i>
                {{__('Print ref')}}
            </button>
            
            <button type="submit" class="btn btn-primary float-right d-inline mr-2" formaction="{{route('admin.medical_reports.pdf4',$group['id'])}}" formmethod="POST">
                <i class="fa fa-print"></i>
                {{__('Print ref 2')}}
            </button>
             <a class="btn btn-info float-right d-inline mr-2" href="{{$group['report_pdf']}}" target="_blank">
