            ...
            <div class="col-lg-12">
                <div class="input-group form-group mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="{{ __('Title') }}" name="title"
                        value="{{ auth()->guard('admin')->user()->title }}" required>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-10">
                ...
                <div class="input-group form-group mb-3">
                    ...
                    <div class="custom-file">
                        <input type="file" accept="image/*" class="custom-file-input" id="exampleInputFile" name="signature2">
                        <label class="custom-file-label" for="exampleInputFile">{{__('Choose your signature 2')}}</label>
                    </div>
                </div>
            ...
            <div class="col-lg-2">
                <div class="card card-primary">
                    <div class="card-header">
                        <h5 class="card-title" style="text-align: center!important;float: unset;">
                            {{__('Signature of BioChemLab')}}
                        </h5>
                    </div>
                    <div class="card-body p-1">
                        <a href="@if(!empty(auth()->guard('admin')->user()->signature2)){{url('uploads/signature2/'.auth()->guard('admin')->user()->signature2)}}@else{{url('img/no-image.png')}}@endif" data-toggle="lightbox" data-title="Signature 2">
                            <img src="@if(!empty(auth()->guard('admin')->user()->signature2)){{url('uploads/signature2/'.auth()->guard('admin')->user()->signature2)}}@else{{url('img/no-image.png')}}@endif"  class="img-thumbnail" id="user_signature" alt="">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-10">
                ...
                <div class="input-group form-group mb-3">
                    ...
                    <div class="custom-file">
                        <input type="file" accept="image/*" class="custom-file-input" id="exampleInputFile" name="signature3">
                        <label class="custom-file-label" for="exampleInputFile">{{ __('Choose your signature 3') }}</label>
                    </div>
                </div>
            ...
            <div class="col-lg-2">
                <div class="card card-primary">
                    <div class="card-header">
                        <h5 class="card-title" style="text-align: center!important;float: unset;">
                            {{ __('Signature of Micro Doc') }}
                        </h5>
                    </div>
                    <div class="card-body p-1">
                        <a href="@if (
                            !empty(auth()->guard('admin')->user()->signature3
                            )) {{ url('uploads/signature3/' .auth()->guard('admin')->user()->signature3) }}@else{{ url('img/no-image.png') }} @endif"
                            data-toggle="lightbox" data-title="Signature 3">
                            <img src="@if (
                                !empty(auth()->guard('admin')->user()->signature3
                                )) {{ url('uploads/signature3/' .auth()->guard('admin')->user()->signature3) }}@else{{ url('img/no-image.png') }} @endif"
                                class="img-thumbnail" id="user_signature" alt="">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
                ...
                <div class="input-group form-group mb-3">
                    ...
                    <div class="custom-file">
                        <input type="file" accept="image/*" class="custom-file-input" id="exampleInputFile"
                            name="signature4">
                        <label class="custom-file-label" for="exampleInputFile">{{ __('Choose your signature 4') }}</label>
                    </div>
                </div>
            ...
            <div class="col-lg-2">
                <div class="card card-primary">
                    <div class="card-header">
                        <h5 class="card-title" style="text-align: center!important;float: unset;">
                            {{ __('Signature of MicroLab') }}
                        </h5>
                    </div>
                    <div class="card-body p-1">
                        <a href="@if (
                            !empty(auth()->guard('admin')->user()->signature4
                            )) {{ url('uploads/signature4/' .auth()->guard('admin')->user()->signature4) }}@else{{ url('img/no-image.png') }} @endif"
                            data-toggle="lightbox" data-title="Signature 4">
                            <img src="@if (
                                !empty(auth()->guard('admin')->user()->signature4
                                )) {{ url('uploads/signature4/' .auth()->guard('admin')->user()->signature4) }}@else{{ url('img/no-image.png') }} @endif"
                                class="img-thumbnail" id="user_signature" alt="">
