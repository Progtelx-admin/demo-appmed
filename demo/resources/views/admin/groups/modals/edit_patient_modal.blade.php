                ...
                <div class="col-lg-4">
                  <div class="form-group">
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" placeholder="{{__('Parent Name')}}" name="passport_no"
                        id="edit_passport_no">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-4">
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6 col-xs-6 col-md-6 pl-0">
                      <div class="input-group mb-3">
                        <select class="form-control" name="age_unit" id="edit_age_unit">
              ...
              <div class="form-group">
                <div class="form-group">
                  <div class="input-group mb-3">
                    ...
                    <select class="form-control" name="vaccinated" placeholder="{{__('Vaccinated')}}" id="edit_vaccinated"
                      >
              ...
              <div class="form-group">
                <div class="form-group">
                  <div class="input-group mb-3">
                    ...
                    <select class="form-control" name="vaccinemodel" placeholder="{{__('Select Vaccine Model')}}" id="edit_vaccinemodel">
