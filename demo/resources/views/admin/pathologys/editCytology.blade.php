            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ __('Edit Cytology') }}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
@section('content')
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">{{ __('Edit Cytology') }}</h3>
        </div>
        <!-- /.card-header -->
        <form method="POST" action="{{ route('admin.pathologys.updateCytology', $pathology['id']) }}" enctype="multipart/form-data"
            id="visit_form">
            @csrf
            @method('put')
            <div class="card-body">
