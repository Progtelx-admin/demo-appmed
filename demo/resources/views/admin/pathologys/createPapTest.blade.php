            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{route('admin.pathologys.index')}}">{{ __('Home PapTest') }}</a>
                    </li>
                    <li class="breadcrumb-item active">{{ __('Create home PapTest') }}</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">{{ __('Create home PapTest') }}</h3>
    </div>
    <!-- /.card-header -->
    <form method="POST" action="{{route('admin.pathologys.storePapTest')}}" enctype="multipart/form-data" id="visit_form">
        @csrf
        <div class="card-body">
            <div class="col-lg-12">
