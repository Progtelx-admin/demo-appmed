              ...
              <div class="form-group">
                  ...
                  <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" placeholder="{{ __('Reference') }}"
                          ...
                          @if (isset($pathology)) value="{{ $pathology['paptest']['reference'] }}" @endif>
                  </div>
              </div>
          </div>
      </div>
                      ...
                      <div class="col-lg-12">
                          <div class="form-group">
                              ...
                              {{-- <textarea name="histopathological" id="histopathological" rows="1" class="form-control"
                                  placeholder="{{ __('Histopathological') }}">
                                    @if (isset($pathology))
...
<textarea wrap="physical" name="macroscopic_examination" id="macroscopic_examination" rows="3"
class="form-control" placeholder="{{ __('Macroscopic examination') }}">
@if (isset($pathology))
...
@endif
  ...
  <input name="report" id="report" value="Pathology" hidden>
