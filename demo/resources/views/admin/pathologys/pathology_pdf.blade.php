...
@endif-->
    ...
    <div class="content" style="padding-top:20px">
        <h2>RAPORTI Pathology</h2>
    </div>



    @if ($pathology['histopathological'])
        <table style="padding-bottom:10%">
            <tr>
                <td style="padding:10px"> Histopathological diagnosis:</td>
                <td width="75%" style="padding:10px">{{ $pathology['histopathological'] }}
                </td>
            </tr>
        </table>
    @endif
