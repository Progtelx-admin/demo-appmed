<div class="row">
    <div class="col-lg-3">
        <div class="form-group">
            ...
            <select name="category_id" class="form-control" id="category" required>
                @if(isset($microbiologyTest)&&isset($microbiologyTest['category']))
                    <option value="{{$microbiologyTest['category_id']}}" selected>{{$microbiologyTest['category']['name']}}</option>
                @endif
            </select>
        </div>
    </div>
    <div class="col-lg-3">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" id="name" @if(isset($microbiologyTest)) value="{{$microbiologyTest->name}}" @endif required>
      </div>
    </div>
    <div class="col-lg-3">
      <div class="form-group">
        <label for="name">{{__('Name 2 srb')}}</label>
        <input type="text" class="form-control" name="name2" id="name2" @if(isset($microbiologyTest)) value="{{$microbiologyTest->name2}}" @endif>
      </div>
    </div>
    <div class="col-lg-3">
      <div class="form-group">
        <label for="shortcut">{{__('Shortcut')}}</label>
        <input type="text" class="form-control" name="shortcut" id="shortcut" @if(isset($microbiologyTest)) value="{{$microbiologyTest->shortcut}}" @endif required>
      </div>
    </div>
    <div class="col-lg-3">
      <div class="form-group">
        <label for="sample_type">{{__('Sample Type')}}</label>
        <input type="text" class="form-control" name="sample_type" id="sample_type" @if(isset($microbiologyTest)) value="{{$microbiologyTest->sample_type}}" @endif required>
      </div>
    </div>
    <div class="col-lg-3">
       <div class="form-group">
            ...
            <div class="input-group form-group mb-3">
                <input type="number" class="form-control" name="price" min="0" id="price" @if(isset($microbiologyTest)) value="{{$microbiologyTest->price}}" @endif required>
      ...
      <div class="form-group" style="color: #f9bf3b">
        ...
        <input style="border-color: #f9bf3b !important" type="text" class="form-control" name="pantheon_id" id="pantheon_id" @if(isset($microbiologyTest)) value="{{$microbiologyTest['pantheon_id']}}" @endif required>
      </div>
    </div>
    <div class="col-lg-12">
        <div class="form-group">
            ...
            <textarea name="precautions" id="precautions" rows="3" class="form-control" placeholder="{{__('Precautions')}}">@if(isset($microbiologyTest)){{$microbiologyTest['precautions']}}@endif</textarea>
        </div>
    </div>
</div>
<br>
                        ...
                        <table class=" table table-striped table-bordered components">
                            ...
                            <tbody class="items">
                                @php
                                  ...
                                  $count_comments=0;
                                @endphp
                                @if(isset($microbiologyTest))
                                    @foreach($microbiologyTest['components'] as $component)
                                        @php
                                            $count++;
                                        @endphp
                                            ...
                                            @if($component['title'])
                                                <td colspan="6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="component[{{$count}}][name2]" placeholder="{{__('Name 2 srb')}}" value="{{$component['name2']}}">
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            @else
                                                        ...
                                                        <table width="100%">
                                                            ...
                                                            @foreach($component['options'] as $option)
                                                                <tr option_id="{{$option['id']}}">
                                                                    ...
                                                                    <td>
                                                                        <button type="button" class="btn btn-danger btn-sm text-center delete_option_mikro">
                                                                            <i class="fa fa-trash"></i>
                                                                        </button>
                                                                    </td>
                                                                </tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="component[{{$count}}][reference_range2]" placeholder="{{__('Reference Range2')}}">{!!$component['reference_range2']!!}</textarea>
                                                    </div>
                                                </td>
                                                <td class="text-center">
                ...
                <div class="row">
                    <div class="col-lg-12 table-responsive">
                        <table class="table table-striped table-bordered" id="comments_table">
                            ...
                            <tbody>
                                @if(isset($microbiologyTest))
                                    @foreach($microbiologyTest['comments'] as $comment)
                                        <tr>
                                            <td>
                                                <div class="form-group">
