...
<div class="row mb-3">
    <div class="col-lg-12">
        ...
        <a @if(isset($previous)) href="{{route('admin.department_biochemistry.show',$previous['id'])}}" @endif class="btn btn-info @if(!isset($previous)) disabled @endif">
            <i class="fa fa-backward mr-2"></i> 
            {{__('Previous')}}
        </a>
        <a @if(isset($next)) href="{{route('admin.department_biochemistry.show',$next['id'])}}" @endif class="btn btn-success @if(!isset($next)) disabled @endif">
            {{__('Next')}}
...
<form method="POST" action="{{route('admin.department_biochemistry.pdf',$group['id'])}}" id="print_form">
    @csrf
    <!-- patient code -->
    ...
    <div class="row mb-3">
        <div class="col-lg-6">
            ...
            <button type="submit" class="btn btn-primary float-right d-inline" formaction="{{route('admin.department_biochemistry.pdf2',$group['id'])}}" formmethod="POST">
                <i class="fa fa-print"></i>
                {{__('Print 2')}}
            </button>
...
@include('admin.department_biochemistry._patient_modal')
