        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">{{ __('services Price List') }}</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="card-body">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-lg-12">
                                                    <div class="card card-primary">
                                                        <div class="card-header">
                                                            <h5 class="card-title">{{__('Import Services')}}</h5>
                                                        </div>
                                                        <div class="card-body">
        ...
        <div class="row">
            <div class="col-lg-12  p-0">
                <form action="{{route('admin.prices.services_submit')}}" method="POST">
                    @csrf
                    <table id="services_prices_table" class="table table-striped table-bordered" width="100%">
                        <thead>
                            <tr>
                                <th width="10px">#</th>
                                <th>{{ __('Name') }}</th>
...
@endsection
@section('scripts')
    <script src="{{url('js/admin/services_prices.js')}}"></script>
@endsection