<div class="row">
    ...
    <div class="col-lg-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="short_description" placeholder="{{__('Short Description')}}" id="short_description"
                @if(isset($contract)) value="{{$contract->short_description}}" @endif required>
        </div>
    </div>
    
    <div class="col-lg-4">
        <div class="form-group">
            <label for="pantheon_bp">{{__('Pantheon BP-ID')}}</label>
            <input type="text" class="form-control" name="pantheon_bp" placeholder="{{__('Pantheon BP-ID')}}" id="pantheon_bp"
                @if(isset($contract)) value="{{$contract->pantheon_bp}}" @endif required>
        </div>
    </div>
</div>
                        ...
                        <table class="table table-striped table-bordered" id="services_table">
                            ...
                            <tbody>
                                @if(isset($contract))
                                    ...
                                    <tr>
                                        <td>
                                            {{$service['priceable']['name']}}
                                        </td>
                                        <td>
                                            <input type="number" class="form-control price" name="services[{{$service['priceable']['id']}}]" value="{{$service['price']}}" price="{{$service['priceable']['price']}}" required>
                                        </td>
                                    </tr>
                                    @endforeach
                                @else
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control price" name="services[{{$service['id']}}]" value="{{$service['price']}}" price="{{$service['price']}}" required>
                                        </td>
                                    </tr>
                                    @endforeach
                                @endif
