...
<body>
            ...
            @if(isset($group['patient']))
                <table width="100%" class="table table-bordered pdf-header">
                    <tbody>
                      ...
                      <h3>burimbp</h3>
                     {{__('Doctor')}} : {{$healthcertificate['doctor_id']}}<br>
                    </tbody>
    ...
    <!--                        @if($reports_settings['show_qrcode'])-->
    <!--                            @if(isset($group['patient']))-->
    <!--                                <img src="https://chart.googleapis.com/chart?chs={{$reports_settings['qrcode-dimension']}}x{{$reports_settings['qrcode-dimension']}}&cht=qr&chl={{url('uploads/pdf/'.'report_'.$group['id'].'.pdf')}}&choe=UTF-8" title="Link to Google.com" />-->
    <!--                            @endif-->
    <!--                        @endif-->
    <!--                    </td>-->
    <!--                    <td width="60%"></td>-->
    ...
    <!--                                <p>-->
    <!--                                    <img src="{{url('uploads/signature/'.$group['signed_by_user']['signature'])}}" alt="" height="300">-->
    <!--                                </p>-->
    <!--                            @endif-->
    <!--                        @endif-->
    <!--                    </td>-->
